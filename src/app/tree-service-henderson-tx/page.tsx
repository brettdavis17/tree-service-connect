// src/app/tree-service-henderson-tx/page.tsx
...
// Get companies within radius of Henderson using PostGIS
async function getHendersonAreaCompanies() {
  try {
    // Henderson coordinates
    const hendersonLat = 32.1528;
    const hendersonLng = -94.7996;
      ...
      SELECT 
        *,
        ST_Distance(
          ...
          ST_Point(${hendersonLng}, ${hendersonLat})::geography
    ...
    console.error('Error fetching companies near Henderson:', error);
    return [];
  }
}

export default async function HendersonTreeServicePage() {
  const companies = await getHendersonAreaCompanies();
  ...
  return (
    <main className="min-h-screen bg-white">
      <Header />
      <CityHero cityName="Henderson" state="TX" companyCount={companies.length} />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          <CompanyListing companies={companies} cityName="Henderson" radius={25} />
          <LeadFormSidebar cityName="Henderson" />
        </div>
      </div>
      
      <ServicesGrid cityName="Henderson" />
      <LocalAreaInfo cityName="Henderson" region="East Texas" />
      <Footer cityName="Henderson" nearbyAreas={nearbyAreas} />
    </main>
  );
}
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tree Service Henderson TX - TreeServiceConnect Directory',
      }
    ],
    locale: 'en_US',
    type: 'website',
...
// // Get companies for Henderson
// async function getHendersonCompanies() {
//   try {
...
// export default async function HendersonTreeServicePage() {
//   const companies = await getHendersonCompanies();
...
//               Tree Service in Henderson, TX
//             </h1>
//             <p className="text-xl text-gray-600 mb-8">
//               Connect with {companies.length} qualified tree service professionals in Henderson and surrounding areas
//             </p>
...
//                 Top Tree Service Companies in Henderson
//               </h2>
...
//                 <p className="text-gray-500">No companies found for Henderson.</p>
...
//                 Tell us about your tree service needs and we'll connect you with qualified professionals in Henderson.
//               </p>
...
//             Tree Services Available in Henderson, TX
//           </h2>
...
//             Tree Services Serving Henderson and Surrounding Areas
//           </h2>
          
//           <div className="prose prose-lg mx-auto text-gray-600">
//             <p>
//               Henderson, Texas is located in the heart of the East Texas Piney Woods, where mature pine and hardwood trees are abundant. 
...
//               and tree service companies serve Henderson and the surrounding areas including Henderson, Arp, Mount Enterprice, and Tatum.
//             </p>

//             <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">
//               Why Choose Tree Service Professionals in Henderson?
//             </h3>
...
//                 Connecting Henderson homeowners with qualified tree service professionals.
//               </p>
//             </div>
...
//                 <li><Link href="/tree-service-kilgore-tx" className="hover:text-white">Kilgore, TX</Link></li>
...
//             <p>&copy; 2025 TreeServiceConnect. Serving Henderson, TX and surrounding areas.</p>
//           </div>
//         </div>
//       </footer>
//     </main>
...
// // SEO Metadata
// export const metadata = {
//   title: 'Tree Service Henderson TX - Top Rated Tree Removal & Trimming Companies',
//   description: 'Find qualified tree service professionals in Henderson, TX. Get free quotes for tree removal, trimming, stump grinding & emergency services. Licensed & insured companies.',
//   keywords: 'tree service Henderson TX, tree removal Henderson, stump grinding Henderson, tree trimming Henderson, arborist Henderson Texas',
// };